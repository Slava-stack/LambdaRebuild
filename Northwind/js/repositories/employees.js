...
function getEmployees() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { employeesQuery } = queries_1.default;
        const output = yield (0, queryTimeExecution_1.default)(connection, employeesQuery);
...
function getEmployee(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const connection = yield (0, promise_1.createConnection)(config_1.default);
        const { employeeQuery } = queries_1.default;
        const output = yield (0, queryTimeExecution_1.default)(connection, employeeQuery, [id]);
        yield connection.end();
        return {
