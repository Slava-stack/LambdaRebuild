...
const coinMarket = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const coinMarketCapMapped = json.data.map((el) => ({ symbol: el.symbol, price: el.quote.USD.price, api: 'coinmarketcap' }));
...
node_cron_1.default.schedule(everyFiveMinutes, () => {
    (() => __awaiter(void 0, void 0, void 0, function* () {
        Promise.all([coinBase(), kuCoin(), coinPaprika(), coinStats(), coinMarket()])
            .then((results) => __awaiter(void 0, void 0, void 0, function* () { return getAverageCoinPrice(results); }))
            .then((coinArray) => {
            pool.getConnection((err, con) => {
                if (err)
                    console.log(err);
